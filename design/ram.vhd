...
architecture rtl of ram is
    ...
    signal ram: ram_type := (
        ...
        3 => x"06102223", -- PC = 12: sw   x1, 100(x0)
        4 => x"fe209ce3", -- PC = 16: bne  x1, x2, -8 (Jump to PC 8)
        5 => x"06402183", -- PC = 20: lw   x3, 100(x0)
        6 => x"00018233", -- PC = 24: add  x4, x3, x0
        7 => x"0000006f", -- PC = 28: jal  x0, 0      <-- END PROGRAM
